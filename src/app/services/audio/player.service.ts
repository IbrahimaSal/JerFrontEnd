...
export class PlayerService {
  ...
  constructor(
    ...
    // this.songs=this.cloudService.getFiles();
...
// songNames = [
//   { name:'Le Frapcore Du Gaulois' },
//   { name: 'Asstalavista Baby'  }, 
//   { name: 'H3X - InsuLean' }, 
//   { name: 'Catalogues' },
//   { name: 'Majeur En Lair' },
//   { name:'Esprit Sombre' },
//   { name:'F-ck Humanity ft H3xJ222' },
//   { name: 'Jartelle' },
//   { name:'La Tribecore Des Suicides' },
//   { name: 'Majeur En Lair' },  
//   { name:'Ndolo' },
//   { name: 'Se Pavaner' }, 
//   { name: 'Seckelles - Mc Solaar (Remix Metiisse Core)' },
//   // { name:'Veuch Ft. H3X (démo)' }
// ];

// songs = this.songNames.map((song, index) => (
//   {
//     id: index,
//     songName: song.name,
//     coverUrl: `assets/MusicCover/${song.name}.jpg`,
//     songUrl: `assets/Music/${song.name}.mp3`,
//   }
// ));

  // songs:any[]=[];
  songs=this.cloudService.getFiles();
